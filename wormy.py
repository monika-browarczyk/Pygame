...
def pauseGame():
    pausedFont = pygame.font.Font('freesansbold.ttf', 40)
    pausedSurf = pausedFont.render('PAUSED - Press any key', True, WHITE)
    pausedRect = pausedSurf.get_rect()
    pausedRect.center = (WINDOWWIDTH // 2, WINDOWHEIGHT // 2)
